...
* In july 2021 MIPI Alliance released White Paper which updates recommendations for debug and trace connectors. This specification is slight extension of connectors described in https://resources.mipi.org/download-mipi-whitepaper-debug-trace-connector[MIPI Debug & Trace Connectors Recommendations]. Extensions are as follows:
