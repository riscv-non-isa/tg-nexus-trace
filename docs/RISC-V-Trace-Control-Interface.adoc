...
|1 |trTsCount |*Internal* timestamp only. +
*1:* counter runs, +
*0:* counter stopped.
|RW |0
|2 |trTsReset |*Internal* timestamp only. +
...
|WARL|SD
|7 |--|Reserved|--|0
|9-8 |trTsPrescale |*Internal* timestamp only. +
...
When set, start matching from a trap with itypes codes specified by 
