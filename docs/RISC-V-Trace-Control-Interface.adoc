...
* TODO: Notes from Michael (related to filtering) taken into account.
...
* Register `trRamRPLow` must accept any 32-bit aligned value in range <0 .. `trRamLimitLow`> inclusive.
